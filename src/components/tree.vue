...
export default {
  ...
  methods: {
    ...
    getLabel(node){
        ...
        if(node && node.parent) {
            console.log(this.selectedLabel)
            console.log(this.selectedLabel ==='')
              this.selectedLabel = node.data[this.propsLabel] + (this.selectedLabel ===''?'':('/'+this.selectedLabel));
            this.getLabel(node.parent);
            console.log(this.selectedLabel)
            // this.selectedLabel = node.parent.data.label
        }
    },
    checkChange() {
  ...
  watch: {
    ...
    selectedLabel(){
        this.$refs.elTree.filter(this.selectedLabel);
    },
    data() {
      this.setSelected();
    }
